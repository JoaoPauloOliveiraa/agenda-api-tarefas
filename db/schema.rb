...
ActiveRecord::Schema.define(version: 2021_12_04_110532) do

  create_table "situacoes", charset: "utf8mb4", force: :cascade do |t|
    t.string "nome", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "tarefas", charset: "utf8mb4", force: :cascade do |t|
